      ...
      { root: 'E', quality: '7', duration: 4 },
                      ...
                      },
                      {
                        ...
                        noodleSample: [
                          ...
                          { note: 12, duration: 4.0, velocity: 1.0 }, // High Root sustain (The "Anthem" note)
                          { note: null, duration: 2.0 },
                    
                          // BARS 5-8: The Shred Run - Dynamics create the "machine gun" effect
                          { note: 16, duration: 0.5, velocity: 1.0 }, { note: 14, duration: 0.5, velocity: 0.7 }, { note: 12, duration: 0.5, velocity: 0.6 }, { note: 11, duration: 0.5, velocity: 0.6 },
                          ...
                          { note: 0, duration: 1.0, velocity: 0.9 }, { note: -1, duration: 0.5, velocity: 0.5 }, { note: 0, duration: 2.5, velocity: 0.8 },
                          { note: null, duration: 4.0 },
                        ]
                      },
                      {
                        ...
                        noodleSample: [
                          ...
                          { note: 0, duration: 2.0, velocity: 0.6 }, // Swell in
                          { note: 3, duration: 1.0, velocity: 0.8 }, 
                          { note: 5, duration: 1.0, velocity: 0.9 }, 
                          { note: 7, duration: 4.0, velocity: 1.0 }, // Crying tone
                          { note: null, duration: 1.0 },
                          { note: 10, duration: 0.5, velocity: 0.7 }, { note: 12, duration: 2.5, velocity: 0.9 }, 
                    
                          // BARS 5-8: The Comedown
                          { note: null, duration: 2.0 },
                          { note: 7, duration: 1.0, velocity: 0.7 }, { note: 5, duration: 1.0, velocity: 0.6 }, { note: 3, duration: 1.0, velocity: 0.5 }, 
                          { note: 0, duration: 3.0, velocity: 0.6 }, // Fade out
