...
- Take the 1st (Root)
- Skip the 2nd, take the 3rd
- Skip the 4th, take the 5th

**Tip:** Use the **Enter Chord Mode** button in the toolbar below to select multiple notes at once, then hit **Strum** to hear them ring out together!

Find the Root (R) now to start our chord.
targetInterval: R
actionText: Locate the Root (R)

## Tutorial Step: The Major 3rd (3)
instruction: The 3rd degree determines if a chord is Major or Minor. In a Major chord, we use a Major 3rd. This is the happy sounding interval 4 frets away from the root.
targetInterval: 3
actionText: Find the Major 3rd (3)

## Tutorial Step: The Perfect 5th (5)
instruction: The 5th degree is the power note. It sounds stable and strong. It is always 7 frets away from the root. Together, 1-3-5 forms the Major Triad.
targetInterval: 5
actionText: Find the Perfect 5th (5)

## Tutorial Step: The Minor 3rd (b3)
instruction: If we flatten the 3rd (move it down 1 fret), we get a Minor 3rd (b3). This one small change turns a happy Major chord into a sad or serious Minor Triad (1-b3-5).
targetInterval: b3
...
type: FIND_INTERVALS
targetInterval: 3
description: To master major chords, you must be able to find the color note. Locate all the Major 3rd (3) intervals in this position.
requiredCount: 3
